          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {[
              ...
              <div key={i} className="text-center">
                <p className="text-2xl md:text-3xl font-bold text-brand-primary mb-1">
      ...
      <section className="section-padding bg-white relative overflow-hidden">
        <div className="max-width-container relative z-10">
          ...
          <div className="space-y-32">
            {[
              { title: "The Foundation", desc: "Started with a vision to provide specialized care for the region, focusing on clinical detoxification.", image: "/10.webp", side: "left", step: "01", bg: "bg-emerald-50/50", border: "border-emerald-100" },
              { title: "Clinical Expansion", desc: "Modernized our medical facilities and integrated advanced psychiatric therapies.", image: "/11.webp", side: "right", step: "02", bg: "bg-amber-50/50", border: "border-amber-100" },
              { title: "State-of-the-Art Campus", desc: "Launched our new bio-centric residential recovery center with premium facilities.", image: "/12.webp", side: "left", step: "03", bg: "bg-indigo-50/50", border: "border-indigo-100" }
            ].map((step, i) => (
              <motion.div
                key={i}
